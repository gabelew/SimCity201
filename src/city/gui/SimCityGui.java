...
public class SimCityGui extends JFrame implements ActionListener {
    ...
    private void createDefaultPeople() {
    	...
    	infoPanel.getPersonPanel().addPerson("sharedwaiter02night");
    	...
    	infoPanel.getPersonPanel().addPerson("clerk01day");
    	infoPanel.getPersonPanel().addPerson("clerk02daycar");
    	infoPanel.getPersonPanel().addPerson("clerk03day");
    	infoPanel.getPersonPanel().addPerson("clerk04daycar");
    	infoPanel.getPersonPanel().addPerson("clerk05day");
    	infoPanel.getPersonPanel().addPerson("clerk06day");
    	...
    	infoPanel.getPersonPanel().addPerson("clerk01night");
    	infoPanel.getPersonPanel().addPerson("clerk02nightcar");
    	infoPanel.getPersonPanel().addPerson("clerk03night");
    	infoPanel.getPersonPanel().addPerson("clerk04nightcar");
    	infoPanel.getPersonPanel().addPerson("clerk05night");
    	infoPanel.getPersonPanel().addPerson("clerk06night");
    	...
    	infoPanel.getPersonPanel().addPerson("repairmancarhome");
