...
public class PersonAgentBusRightTest extends TestCase{
	...
	public void setUp() throws Exception{
		...
		h = new MockHome(new Point(657,68));
	...
	public void testPersonGoToBusStop0RightThenDroppedOfAtBusStop1() {
		...
		int i =0;
		while(person.personGui.xPos != 797 || person.personGui.yPos != 85){
			if(i==1000){
		...
		assertTrue("personAgent should have logged \"msgWaitingForBus recieved from personAgent\" but didn't. His log reads instead: " 
				+ ((BusAgent)person.busRight).log.getLastLoggedEvent().toString(), ((BusAgent)person.busRight).log.containsString("msgWaitingForBus recieved from personAgent"));

		assertEquals("BusAgent's bus stop 0 should have 1 passenger. Instead it has " + ((BusAgent)person.busRight).busStops.get(0).passengers.size(),
				((BusAgent)person.busRight).busStops.get(0).passengers.size(), 1);
		
		assertEquals("BusAgent's bus stop 0 should have passenger where state is pickup. Instead it has " + ((BusAgent)person.busRight).busStops.get(0).passengers.get(0).stopEvent.toString(),
				((BusAgent)person.busRight).busStops.get(0).passengers.get(0).stopEvent, StopEvent.pickUp);
		...
		assertTrue("busAgent should have logged \"msgComingAboard recieved from personAgent\" but didn't. His log reads instead: " 
				+ ((BusAgent)person.busRight).log.getLastLoggedEvent().toString(), ((BusAgent)person.busRight).log.containsString("msgComingAboard recieved from personAgent"));
		
		
		i =0;
		while(person.personGui.xPos != 830 || person.personGui.yPos != 85){
			if(i==1000){
				assertTrue("We never reached destination. Instead, the current position is : (" + person.personGui.xPos + ", " + person.personGui.yPos + ")" , false);
			}
			i++;
		...
		assertEquals("BusAgent's bus stop 1 should have 1 passenger. Instead it has " + ((BusAgent)person.busRight).busStops.get(1).passengers.size(),
				((BusAgent)person.busRight).busStops.get(1).passengers.size(), 1);
		
		assertEquals("BusAgent's bus stop 1 should have passenger where state is dropOff. Instead it has " + ((BusAgent)person.busRight).busStops.get(1).passengers.get(0).stopEvent.toString(),
				((BusAgent)person.busRight).busStops.get(1).passengers.get(0).stopEvent, StopEvent.dropOff);
	...
	public void testPersonGoToBusStop0RightThenDroppedOfAtBusStop3() {
		//setUp() runs first before this test!
		...
		assertEquals("BusAgent's bus stop 3 should have 1 passenger. Instead it has " + ((BusAgent)person.busRight).busStops.get(3).passengers.size(),
				((BusAgent)person.busRight).busStops.get(3).passengers.size(), 1);
		
		assertEquals("BusAgent's bus stop 3 should have passenger where state is dropOff. Instead it has " + ((BusAgent)person.busRight).busStops.get(3).passengers.get(0).stopEvent.toString(),
				((BusAgent)person.busRight).busStops.get(3).passengers.get(0).stopEvent, StopEvent.dropOff);
	...
	public void testPersonGoToBusStop0RightThenDroppedOfAtBusStop2() {
		//setUp() runs first before this test!
		...
		assertEquals("BusAgent's bus stop 1 should have 1 passenger. Instead it has " + ((BusAgent)person.busRight).busStops.get(2).passengers.size(),
				((BusAgent)person.busRight).busStops.get(2).passengers.size(), 1);
		assertEquals("BusAgent's bus stop 1 should have passenger where state is dropOff. Instead it has " + ((BusAgent)person.busRight).busStops.get(2).passengers.get(0).stopEvent.toString(),
				((BusAgent)person.busRight).busStops.get(2).passengers.get(0).stopEvent, StopEvent.dropOff);
